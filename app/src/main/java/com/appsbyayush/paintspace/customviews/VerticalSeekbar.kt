...
class VerticalSeekbar(
    ...
    private fun setupSeekbarCoordinates() {
        ...
        Log.d(TAG, "setupSeekbarCoordinates: $seekbarHeight")
    }
...
//        }
    ...
    private fun onMotionEventActionMove(event: MotionEvent) {
        Log.d(TAG, "onMotionEventActionMove: ${event.y}")

        val unitProgressHeight = seekbarHeight / 100
        val verticalMovement = touchStartY - event.y

        Log.d(TAG, "onMotionEventActionMove: unitProgressHeight -- $unitProgressHeight")
        Log.d(TAG, "onMotionEventActionMove: verticalMovement -- $verticalMovement")
    ...
    private fun setProgressAccordingToTouch(event: MotionEvent) {
        ...
        Log.d(TAG, "setProgressAccordingToTouch: Calculated Progress -- $calculatedProgress")
