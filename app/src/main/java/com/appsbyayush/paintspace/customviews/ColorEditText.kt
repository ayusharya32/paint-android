...
class ColorEditText(
    ...
    private fun checkLinesAndRestrictInput() {
        if(lineCount > 12) {
            Log.d(TAG, "checkLinesAndRestrictInput: Restricting..")
    ...
    private fun drawTextBackground(canvas: Canvas?) {
        ...
        Log.d(TAG, "drawTextBackground: lineCount: $lineCount")
        broadestLine = 0F
        ...
        for(currentLineIndex in 0 until lineCount) {
            ...
            Log.d(TAG, "drawTextBackground: Line Start: $currentLineStart Line End - $currentLineEnd")
            Log.d(TAG, "drawTextBackground: Line Text: $currentLineText")
            ...
            Log.d(TAG, "drawTextBackground: lineBackgroundWidth $lineBackgroundWidth")
            if(broadestLine < lineBackgroundWidth) {
                broadestLine = lineBackgroundWidth
            }
            Log.d(TAG, "drawTextBackground: lineBackgroundWidth -- broadestLine $broadestLine")
    ...
    private fun setAppliedStylesToText() {
        Log.d(TAG, "setAppliedStylesToText: Called")
        ...
        Log.d(TAG, "setAppliedStylesToText: $textStyle")
    ...
    private fun updateBackgroundAndTextColor() {
        if(addBackgroundToText) {
            ...
            Log.d(TAG, "getTextColorAccordingToBackground toggleTextBackground: $fontColorWithBackground")
    ...
    private fun getTextColorAccordingToBackground(color: Int): Int {
        ...
        val newColorId = when {
            colorDarkness >= 0 && colorDarkness < 0.4 -> {
                Log.d(TAG, "getTextColorAccordingToBackground: Black")
                R.color.black
            }
            colorDarkness >= 0.4 && colorDarkness < 0.6 -> {
                Log.d(TAG, "getTextColorAccordingToBackground: Grey")
                R.color.grey_200
            }
            else -> {
                Log.d(TAG, "getTextColorAccordingToBackground: White")
                R.color.white
            }
        }
...
//        }
        ...
        Log.d(TAG, "saveTextImage: x : $textStartX")
        Log.d(TAG, "saveTextImage: y : $textStartY")
        Log.d(TAG, "saveTextImage: finalWidth : $finalImageWidth")
        Log.d(TAG, "saveTextImage: finalHeight : $finalImageHeight")
        Log.d(TAG, "saveTextImage: Bitmap Width : ${srcBitmap.width}")
        Log.d(TAG, "saveTextImage: Bitmap Height : ${srcBitmap.height}")
        Log.d(TAG, "saveTextImage: broadestLine : $broadestLine")
        Log.d(TAG, "saveTextImage: First Line Top : ${lastLineRect.top}")
        Log.d(TAG, "saveTextImage: Last Line Bottom : ${lastLineRect.bottom}")
