...
class DrawingViewModel @Inject constructor(
    ...
    fun onFontItemClicked(fontItem: FontItem) {
        Log.d(TAG, "onFontItemClicked: ${fontItem}")
        fontItem.fontFileLocalUri?.let {
            Log.d(TAG, "onFontItemClicked: Getting From Downloaded Font..")
    ...
    private fun startFontDownload(fontItem: FontItem) {
        Log.d(TAG, "startFontDownload: Called")
    ...
    sealed class Event {
        ...
        object EmptyDrawing: Event()
        object ProceedToSaveDrawing: Event()
        object SaveDrawingImage: Event()
        object DrawingSaved: Event()
        object DrawingSavedAsDraft: Event()

        object ChangesDiscarded: Event()
