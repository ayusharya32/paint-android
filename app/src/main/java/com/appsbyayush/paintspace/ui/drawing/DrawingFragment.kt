...
class DrawingFragment: Fragment(R.layout.fragment_drawing) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.d(TAG, "onViewCreated: Called Args $args")
    ...
    private fun setupButtons() {
        binding.apply {
            ...
            fabBrush.setOnClickListener {
                Log.d(TAG, "setupButtons: Brush Button Clicked")
            ...
            DrawingViewModel.UIMode.MODE_TEXT -> {
                binding.apply {
                    if(cetText.getCurrentTextElement() == null) {
                        Log.d(TAG, "onBackButtonClicked: TEXT ELEMENT NOT PRESENT")
                        setUiModeIdle()
                        setupFragmentViews()
                    ...
                    Log.d(TAG, "onBackButtonClicked: TEXT ELEMENT FOUND")
    ...
    private fun setupFragmentViews() {
        binding.apply {
            ...
            // TEXT
            Log.d(TAG, "setupFragmentViews: ${viewModel.currentUiMode}")
            ...
            object: VerticalSeekbar.OnSeekbarChangeListener {
                override fun onProgressChanged(progress: Int) {
                    binding.apply {
                        ...
                        Log.d(TAG, "onProgressChanged: Progress - $progress Transparency - $transparency")
                    }
                }
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.fontsFlow.collect { response ->
                    Log.d(TAG, "setupFontsFlowCollector: FontsFlow ${response.data}")
                    binding.apply {
                        rvFonts.isVisible = viewModel.currentUiMode == DrawingViewModel.UIMode.MODE_TEXT
                ...
                viewModel.events.collect { event ->
                    when(event) {
                        ...
                        is DrawingViewModel.Event.LoadDrawingDraft -> {
                            Log.d(TAG, "setupUIEventCollector: Loading Draft.. ${event.drawingItems}")
                        ...
                        is DrawingViewModel.Event.EmptyTextDone -> {
                            Log.d(TAG, "setupUIEventCollector: Text Empty")
                            setUiModeIdle()
                            setupFragmentViews()
                        ...
                        is DrawingViewModel.Event.SaveTextImage -> {
                            Log.d(TAG, "setupUIEventCollector: Text NOT Empty")
        ...
        val saveDrawingDialog = SaveDrawingDialog(
            ...
            object: SaveDrawingDialog.SaveDrawingClickEvent {
                override fun onSaveBtnClicked() {
                    Log.d(TAG, "onSaveBtnClicked: Called")
                    viewModel.saveDrawing()
                }

                override fun onSaveAsDraftBtnClicked() {
                    Log.d(TAG, "onSaveAsDraftBtnClicked: Called")
